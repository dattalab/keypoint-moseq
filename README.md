...
Use conda environment files to automatically install the appropriate GPU drivers and other dependencies. 
...
4. [Optional] Make the new environment accessible in jupyter (this may be required if launching jupyter from another environment)
```
...
1. For pip installation with GPU support, manually install install the appropriate driver and CUDA version. CUDA ≥11.1 and cuDNN ≥8.2 are required. [This section of the DeepLabCut docs](https://deeplabcut.github.io/DeepLabCut/docs/installation.html#gpu-support) may be helpful.
